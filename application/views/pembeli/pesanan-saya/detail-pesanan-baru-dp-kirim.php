...
<body class="">
  <header>
    <nav class="nav" style="background-image: linear-gradient(to right, #00b7f8, #009dff, #0080ff, #005dff, #0029ee);">
        ...
        <div class="card">
          <ul class="collection">
            <li class="collection-item">
              <b class="teal-text darken-1">STATUS PEMESANAN</b><span class="secondary-content badge red accent-2 status-pemesanan" style="font-size: 15px; border-radius: 8px;"></span>
            </li>
          </ul>
        </div>
        <div class="card">
