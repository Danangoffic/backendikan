      ...
      if($JenisPembayaran=="Full Transfer"){
                ...
                <div class="col s12">
                    <div class="card">
                        <div class="collection">
                            ...
                            <ul class="collection-item">Tanggal Pengambilan yang Diajukan :<span class="badge tanggal-pengiriman-diajukan">02/01/2020</span></ul>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="col s12">
                ...
                <div class="card">
                <ul class="collection">
                    <ul class="collection-item"><h5>DETAIL PEMBAYARAN</h5></ul>
                    <ul class="collection-item">Metode Pembayaran :<span class="secondary-content">Transfer dan Tunai</span></ul>
                    <li class="collection-item">Total Harga Produk :<span class="secondary-content total-harga-produk">Rp</span></li>
                    <li class="collection-item teal-text darken-1"><b>Total Pembayaran :<span class="secondary-content total-pembayaran">Rp</span></b></li>
                    <li class="collection-item teal-text darken-1"><b>Minimal Transfer :<span class="secondary-content minimal-transfer">Rp</span></b></li>
            ...
            <div class="card">
                <div class="collection red darken-1 white-text">
                <p class="flow-text center-align">
                    Silahkan ambil produk sesuai<br>
                    <b><a class="waves-effect waves-light modal-trigger white-text" href="#modal1">TANGGAL PENGAMBILAN</a></b><br>
                    dan melakukan pembayaran sebesar<br><b><a class="waves-effect waves-light modal-trigger white-text" href="#modal2">SISA TAGIHAN</a></b><br>
                    secara langsung ke 
                    <b>PENJUAL</b></p>
                </div>
            </div>
